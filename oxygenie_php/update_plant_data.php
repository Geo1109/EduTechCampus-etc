...
if(!isset($_POST['pump_1'])) $_POST['pump_1'] = '';
if(!isset($_POST['pump_2'])) $_POST['pump_2'] = '';
if(!isset($_POST['pump_3'])) $_POST['pump_3'] = '';
if(!isset($_POST['pump_4'])) $_POST['pump_4'] = '';
...
if ( gettype(json_decode($data)) == "string" || $dataType == 'NULL' ) {
    ...
    echo "pump 1: ${$pump_1}";
    $pump1Type = gettype(json_decode($pump_1));
    echo "pump1 variable has the type: {$pump1Type}"; 
}
